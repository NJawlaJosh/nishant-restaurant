...
class UserSchema(ma.SQLAlchemySchema):
    ...
    state = fields.String(
        required=True, validate=validate.And(validate.Length(min=2, max=100, error="State must be between 2 and 100 characters long"), validate.ContainsOnly(indian_states, error="State must be a valid Indian state")))
